...
def get_admin_credentials():
    ...
    try:
        ...
        if not keys_response['AccessKeyMetadata']:
            ...
            print_status("💡", "Create access key in AWS Console or use credentials script")
            return None
...
def main():
    ...
    print_status("💡", "After setting secrets, the GitHub Actions workflow will work automatically!")
